 ...
 */
public class StackAsList<T> extends StackSecondary<T> {
    ...
    public final void transferFrom(Stack<T> source) {
        ...
        assert source instanceof StackAsList<?> : ""
         ...
         */
        StackAsList<T> localSource = (StackAsList<T>) source;
    ...
    public final void push(T x) {
        ...
        // Store x in new node and set new node as new top.
    ...
    public final T pop() {
        ...
        // Point top to next node if it exists, null otherwise.
    ...
    private final class Stack2Iterator implements Iterator<T> {
        ...
        private Stack2Iterator() {
            this.current = StackAsList.this.top;
            assert StackAsList.this.conventionHolds();
        }
