...
/**
 * CSE 2221 Lab #15. Program to test arrays, references, and arrays of
 * references.
 *
 * @author Faye Leigh
 */
public final class ArraysAndReferences {
    ...
    private static NaturalNumber[] partialProducts(NaturalNumber[] nnArray) {
        ...
        NaturalNumber[] products = new NaturalNumber[nnArray.length];

        products[0] = new NaturalNumber2(nnArray[0]);
        for (int i = 1; i < nnArray.length; i++) {
            NaturalNumber product = new NaturalNumber2(products[i - 1]);
    ...
    public static void main(String[] args) {
         ...
         */
        final int val = 6;
        NaturalNumber[] array = new NaturalNumber[val];
