...
public final class HashingExploration {
     ...
     * @ensures hashCode = [hash code value for the given String]
     */
    private static int hashCode1(String s) {
        assert s != null : "Violation of: s is not null";
...
//        String textFileName = "labs/labs/lab08/HashingExploration.java";
        String textFileName = "data/lab08/mod30.txt";
        ...
        while (!textFile.atEOS()) {
            ...
            if (!counted.contains(line)) {
                int bucket = mod(hashCode1(line), hashTableSize);
                counts[bucket]++;
                counted.add(line);
            }
        }
