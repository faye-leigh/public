...
public class SetOnBST<T extends Comparable<T>> extends SetSecondary<T> {
        ...
        if (t.size() > 1) {
            ...
            if (i < 0) {
                ...
                if (right.size() > 0) {
                    ...
                    root = removeFromTree(left, left.root());
                }
            }
            t.assemble(root, left, right);
        } else {
    ...
    public final void transferFrom(Set<T> source) {
        ...
        assert source instanceof SetOnBST<?> : ""
         ...
         */
        SetOnBST<T> localSource = (SetOnBST<T>) source;
