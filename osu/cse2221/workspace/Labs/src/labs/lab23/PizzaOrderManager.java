...
/**
 * CSE 2221 Lab #23. Simple pizza order manager: inputs orders from a file and
 * computes and displays the total price for each order.
 *
 * @author Faye Leigh
 */
public final class PizzaOrderManager {
    ...
    private static void putPrice(SimpleWriter output, int price) {
        ...
        final int hundred = 100, ten = 10;
        int dollars = price / hundred, cents = price % hundred;
    ...
    public static void main(String[] args) {
        SimpleReader in = new SimpleReader1L("data/lab23/orders.txt");
         ...
         */
        getPriceMap("data/lab23/sizes.txt", sizeMenu);
        getPriceMap("data/lab23/toppings.txt", toppingMenu);
        /*
