...
public abstract class StatementTest {
    ...
    /**
     * Test kind of a IF-ELSE statement.
     */
    @Test
    ...
    public final void testAddToBlockEnd() {
        ...
        Statement nestedTest = sTest.removeFromBlock(1);
        Statement nestedRef = sRef.removeFromBlock(1);
        sRef.addToBlock(index, nestedRef);

        /*
         * The call
         */
        sTest.addToBlock(index, nestedTest);
    ...
    /**
     * Test removeFromBlock at interior leaving a non-empty block behind.
     */
    @Test
    ...
    /**
     * Test removeFromBlock at end leaving a non-empty block behind.
     */
    @Test
    public final void testRemoveFromBlockEndLeavingNonEmpty() {
        ...
        Statement sTest = this.createFromFileTest(FILE_NAME_1);
        Statement sRef = this.createFromFileRef(FILE_NAME_1);
        Statement nestedRef = sRef.removeFromBlock(index);

        /*
         * The call
         */
        Statement nestedTest = sTest.removeFromBlock(index);
