...
public final class SequenceSmoothTest {
    ...
    public void test1() {
         ...
         */
        Sequence<Integer> seq1 = this.createFromArgs(2, 2, 2);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(2, 2, 2);
        Sequence<Integer> seq2 = this.createFromArgs(2, 2);
    ...
    public void test2() {
        ...
        Sequence<Integer> seq2 = this.createFromArgs(2, 2, 2);
    ...
    public void test6() {
         ...
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(2, 2);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(2, 2);
        Sequence<Integer> seq2 = this.createFromArgs();
