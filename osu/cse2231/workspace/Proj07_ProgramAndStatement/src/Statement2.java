...
public class Statement2 extends StatementSecondary {
    ...
    public final void addToBlock(int pos, Statement s) {
        ...
        Sequence<Tree<StatementLabel>> block = this.rep.newSequenceOfTree();
        StatementLabel label = this.rep.disassemble(block);
        block.add(pos, localS.rep);
        this.rep.assemble(label, block);
        s.clear();
    ...
    public final Statement removeFromBlock(int pos) {
        ...
        Tree<StatementLabel> tmp = children.remove(pos);
        s.rep.transferFrom(tmp);
    ...
    public final void assembleCall(String inst) {
        ...
        this.rep.assemble(call, this.rep.newSequenceOfTree());
    }
    ...
    public final String disassembleCall() {
        ...
        StatementLabel label = this.rep.disassemble(this.rep.newSequenceOfTree());
        this.createNewRep();
